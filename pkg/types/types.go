...
type Input struct {
	...
	OutputIndex uint32   `json:"output_index"`               // [non-coinbase] Index of the corresponding UTXO
	...
	Witness     []string `json:"txinwitness"`                // [non-coinbase] Array of hex-encoded witness data
